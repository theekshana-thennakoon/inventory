...
<body>
    ...
    <div class="container profile-container">
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 ms-sm-auto px-md-4">
                <div class="card profile-card">
                    ...
                    <div class="profile-info">
                        <p class="mb-2"><i class="bi bi-envelope"></i> <strong>Email:</strong> <?php echo htmlspecialchars($user['email']); ?></p>
                        <p class="mb-0"><i class="bi bi-person-badge"></i> <strong>Role:</strong> <?php echo htmlspecialchars(ucfirst($user['status'])); ?></p>
                    </div>
